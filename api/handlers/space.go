...
func NewSpace(apiBaseURL url.URL, spaceRepo CFSpaceRepository, routeRepo CFRouteRepository, orgRepo CFOrgRepository, requestValidator RequestValidator) *Space {
	return &Space{
